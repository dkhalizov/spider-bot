...
(
    ...
    temperature_requirement_celsius DECIMAL
(
    3,
    1
)
...
(
    ...
    species_id INTEGER REFERENCES tarantula_species
(
    id
),
    ...
    current_molt_stage_id INTEGER REFERENCES molt_stages
(
    id
),
    current_health_status_id INTEGER REFERENCES health_statuses
(
    id
),
    last_health_check_date DATE,
    enclosure_number VARCHAR
(
    20
) UNIQUE,
    notes TEXT,
...
(
    ...
    size_type_id INTEGER REFERENCES cricket_size_types
(
    id
),
...
(
    ...
    cricket_colony_id INTEGER REFERENCES cricket_colonies
(
    id
),
    number_of_crickets INTEGER NOT NULL,
    feeding_status_id INTEGER REFERENCES feeding_status_types
(
    id
),
    notes TEXT,
...
(
    ...
    molt_stage_id INTEGER REFERENCES molt_stages
(
    id
),
    pre_molt_length_cm DECIMAL
(
    4,
    1
),
    post_molt_length_cm DECIMAL
(
    4,
    1
),
...
(
    ...
    health_status_id INTEGER REFERENCES health_statuses
(
    id
),
